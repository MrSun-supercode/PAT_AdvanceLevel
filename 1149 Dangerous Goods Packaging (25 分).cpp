...
////}
///*
//柳婼大佬：使用map数据结构结合vector保存，比我的方法好，我的方法要开v【99999】的vector数组
//*/
//#include<iostream>
//#include<set>
//#include<map>
...
//		int str1, str2;
//		cin >> str1 >> str2;
//		P[str1].push_back(str2);//在str1中保存str2
//		P[str2].push_back(str1);//在str2中保存str1
//	}
//	for (int i = 0; i < m; i++)
//	{
//		int temp;
...
//		for (auto it = s.begin(); it != s.end(); it++)
//		{
//			if (P[*it].size() != 0)//如果当前s中的元素有互斥物品
//			{
//				for (int i = 0; i < P[*it].size(); i++)//遍历其互斥物品，看s中是否有其互斥物品
//				{
//					if (s.find(P[*it][i]) != s.end())//若有，则输出No,并直接跳出循环
//					{
//						cout << "No" << endl;
//						flag = true;
//						break;
